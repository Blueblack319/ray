...
class ReorderMapTransformRule(Rule):
    ...
    def apply(self, plan: PhysicalPlan) -> PhysicalPlan:
        ("ReorderMapTransformRule is Added\n")
...
class ReorderMapTransformDescendingRule(ReorderMapTransformRule):
